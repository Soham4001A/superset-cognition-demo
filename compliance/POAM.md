...
| POAM-0006 | Unpinned scanner installs (`semgrep`, `bandit`, `pip-licenses`) in `compliance/scanners/run_scans.sh` | Manual review | RA-5 / SI-2 / SR-3 | Medium | Remediated | #18 | issue #6 | 2026-07-26 | pinned semgrep==1.170.0, bandit==1.9.4, pip-licenses==5.5.5 via `have_pinned` helper that verifies the running version |
